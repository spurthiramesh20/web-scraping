...
load_dotenv()
st.set_page_config(page_title="Tarento AI", page_icon="T", layout="wide")
...
def load_system_prompts():
    try:
        with open(os.path.join("prompts", "docs_agent_prompt.py"), "r", encoding="utf-8") as f:
            content = f.read()
...
with st.sidebar:
    st.image("https://www.tarento.com/images/logo.png", width=150)
